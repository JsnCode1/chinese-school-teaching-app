...
}> = [
  {
    ...
    tips: {
      en: [
        ...
        "Punctuation stays visible on the page but is left out of the spoken reading.",
        "Use the background button to show or hide the story background images.",
        "Poem stories can be read line by line, with compact or spacious line spacing.",
      ],
      zh: [
        ...
        "点击“读全课文”可以一次听完整篇故事。",
        "每个字下面都有拼音，方便跟读和练习发音。",
        "标点符号会显示在页面上，但朗读时不会读出标点。",
        "点击背景按钮可以显示或隐藏课文背景图片。",
        "诗歌课文可以逐行朗读，也可以切换紧凑或宽松的行距。",
      ],
    },
  },
  {
    ...
    tips: {
      en: [
        ...
        "Use the button-position control at the top to move the character controls to the left or right side.",
      ],
      zh: [
        "点击汉字卡片可以打开详细弹窗。",
        "点击“拼音”按钮可以显示这个字的发音。",
