...
export default function ContentCard({ chinese, pinyin, english, extra }: ContentCardProps) {
  return (
    <article className="rounded-3xl border-2 border-orange-200 bg-white p-6 shadow-md">
      ...
      {extra && <p className="rounded-2xl bg-orange-50 p-3 text-gray-700"><strong>Example:</strong> {extra}</p>}
    </article>
  );
}
